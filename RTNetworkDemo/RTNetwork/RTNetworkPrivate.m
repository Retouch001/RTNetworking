...
#ifdef DEBUG
    if (![RTNetworkConfig sharedConfig].debugLogEnabled) {
        return;
    }
    va_list argptr;
...
@implementation RTBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<RTRequestAccessory> accessory in self.requestAccessories) {
